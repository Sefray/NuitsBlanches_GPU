...
BENCHMARK_CAPTURE(BM_Detection_file_nb, nuits_blanches_gpu_seven, GPU_7)->Unit(benchmark::kMillisecond)->UseRealTime();
...
BENCHMARK_CAPTURE(BM_Detection_folder_nb, nuits_blanches_gpu_seven, GPU_7)
    ->Unit(benchmark::kMillisecond)
    ->UseRealTime();
